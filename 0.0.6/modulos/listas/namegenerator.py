import random
from nomesLista_First import nomes_list
from nomesLista_Second import sobrenomes_list
...
O que deseja fazer?: """)
            if str(self.ask_opt) == "exit":
                ...
                self.check_opt(nomes_list)
            elif str(self.ask_opt) == "b":
                self.check_opt(sobrenomes_list)
            elif str(self.ask_opt) == "c":
                self.check_opt(nomes_list, sobrenomes_list)
#-----------------------------------------------------------------------------#
