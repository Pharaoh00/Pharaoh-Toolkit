...
def main():
	...
	def PasswordGenerator():
		...
		while(True):
			...
			#Bagunça
			if not passGen.isdigit() and str(passGen) != "-v" and str(passGen) != "exit": # Tudo diferente de numeros ou -v ou exit não passa
				print("\nSomente numeros\n")
				...
				while(True):
					...
					if askOpt != "fraca" and askOpt != "media" and askOpt != "forte" and askOpt != "insana" and askOpt != "exit" and askOpt != "-v" and askOpt != "exit": # Tudo diferente entre as opções não passa daqui. Caso queira adicionar outra coisa no menu, NÃO ESQUECER, de adicionar aqui também.
